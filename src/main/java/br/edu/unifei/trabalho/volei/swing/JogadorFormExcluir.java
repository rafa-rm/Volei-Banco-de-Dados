...
public class JogadorFormExcluir extends JFrame {
	...
	public JogadorFormExcluir() {
		...
		JLabel lblJogadores = new JLabel("Excluir um jogador");
		lblJogadores.setFont(new Font("Dialog", Font.BOLD, 14));
		lblJogadores.setBounds(83, 11, 131, 29);
		...
		btnExcluir.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				em.remove(em.find(Jogador.class, jogador.getNome()));
		...
		btnExcluir.setBounds(101, 364, 98, 26);
